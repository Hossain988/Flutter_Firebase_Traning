...
```
lib/
├── main.dart                 # App entry point with Provider setup & auth routing
├── models/
│   ├── note.dart            # Note data model (TODO: implement toMap/fromMap)
│   └── user_model.dart      # User data model with additional fields
├── services/
│   ├── firebase_service.dart # Firebase Firestore operations (TODO: implement)
│   └── auth_service.dart    # Firebase Auth operations (TODO: implement)
├── providers/
│   ├── notes_provider.dart  # Notes state management with Provider
│   └── auth_provider.dart   # Authentication state management
├── screens/
│   ├── home_screen.dart     # Main screen with notes list and filters
│   ├── login_screen.dart    # User login screen
│   ├── signup_screen.dart   # User registration with additional info
│   └── add_edit_note_screen.dart # Create/edit note screen
├── widgets/
│   ├── note_card.dart       # Individual note card widget
│   └── filter_chips.dart    # Filter UI components
└── utils/
    └── constants.dart       # App constants (categories, priorities, etc.)
```
...
- [ ] Handle Timestamp ↔ DateTime conversions
...
- ✅ Store additional user information (name, phone, bio, address, date of birth)
...
- ✅ Filter by category, priority, tags, and date
